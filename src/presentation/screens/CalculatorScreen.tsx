...
import { calculator } from '../../data-calculator/calculatorObject';
...
export const CalculatorScreen = () => {
  ...
  const {
    ...
    divideOperation, multiplyOperation, sutractOperation, addOperation, calculateResult
  } = useCalculator();

  return (
    <View style={ styles.calculatorContainer }>
      <View style={ { paddingHorizontal: 35, paddingBottom: 20 } }>
      ...
      <View style={ styles.row }>
        <CalculatorButton onPress={ clean } label='C' textBlack color={ colors.lightGray } />
        <CalculatorButton onPress={ () => toggleSign() } label='+/-' textBlack color={ colors.lightGray } />
        <CalculatorButton onPress={ deleteOperation } label='DEL' textBlack color={ colors.lightGray } />
      ...
      <View style={ styles.row }>
        ...
        <CalculatorButton onPress={ sutractOperation } label='-' color={ colors.orange } />
      </View>
      ...
      <View style={ styles.row }>
        ...
        <CalculatorButton onPress={ calculateResult } label='=' color={ colors.darkGray } />
      </View>
